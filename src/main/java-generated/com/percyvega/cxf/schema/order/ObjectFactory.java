...
package com.percyvega.cxf.schema.order;
 ...
 * generated in the com.percyvega.cxf.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://cxf.percyvega.com/schema/Order", "orderInquiryResponse");
    private final static QName _OrderInquiry_QNAME = new QName("http://cxf.percyvega.com/schema/Order", "orderInquiry");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.percyvega.cxf.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.percyvega.com/schema/Order", name = "orderInquiryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.percyvega.com/schema/Order", name = "orderInquiry")
