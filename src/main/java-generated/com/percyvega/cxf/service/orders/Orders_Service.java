 ...
 * 2016-01-10T04:01:05.083-05:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/C:/PERCYVEGA/Workspaces/IdeaProjects/apache-cxf-jax-ws/src/main/resources/wsdl/Orders.wsdl",
                  targetNamespace = "http://cxf.percyvega.com/service/Orders") 
public class Orders_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://cxf.percyvega.com/service/Orders", "Orders");
    public final static QName OrdersSOAP = new QName("http://cxf.percyvega.com/service/Orders", "OrdersSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/PERCYVEGA/Workspaces/IdeaProjects/apache-cxf-jax-ws/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/PERCYVEGA/Workspaces/IdeaProjects/apache-cxf-jax-ws/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
